...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/inventory.StockAdjustmentRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/inventory.MovementResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/inventory.CreateCategoryRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/reports.DailySalesReport"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/reports.StaffPerformance"
                            }
                        }
                    }
                }
        ...
        "/reports/summary": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Report type: monthly or yearly",
                        "name": "type",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/reports.SummaryReport"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/reports.ProductSalesPerformance"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/users.AuditLogResponse"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users.CreateStaffRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "inventory.CreateCategoryRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "inventory.StockAdjustmentRequest": {
            "type": "object",
            "required": [
                "product_id",
                "quantity",
        ...
        "reports.ProductSalesPerformance": {
            "type": "object",
            "properties": {
                "product_id": {
                    "type": "string"
