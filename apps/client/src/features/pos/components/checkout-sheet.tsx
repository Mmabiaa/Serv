...
function ReceiptView({
  ...
  return (
    <div className="py-4 text-center">
      ...
      <h2 className="text-xl font-extrabold tracking-tight">Payment received</h2>
      <p className="text-sm text-muted-foreground mt-1">
        Transaction {txId} · {method.toUpperCase()}
      </p>

      <div className="mt-6 bg-muted rounded-2xl p-5 text-left">
        <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
          Kigali Mini Mart · Lagos
        </p>
      ...
      <div className="mt-5 grid grid-cols-2 gap-2">
        <button
          type="button"
          className="bg-card border border-border py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-muted"
        >
        ...
        <button
          type="button"
          onClick={onClose}
          className="bg-foreground text-background py-3.5 rounded-xl font-bold text-sm"
        >
          New sale
        </button>
      </div>
