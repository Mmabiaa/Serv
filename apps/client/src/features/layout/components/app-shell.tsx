...
const managerNav = [
  ...
  { to: "/history", label: "Sales", longLabel: "Sales History", icon: History },
  { to: "/inventory", label: "Stock", longLabel: "Inventory", icon: Package },
  { to: "/inventory/movements", label: "Moves", longLabel: "Stock Movements", icon: ArrowLeftRight },
  ...
  { to: "/activity", label: "Audit", longLabel: "Activity Logs", icon: ShieldCheck },
] as const;
  ...
  if (user?.role !== "manager") {
    return (
      <div className="p-10 text-center">
        ...
        <p className="text-slate-500 mt-2">Only managers can access this page.</p>
        <Link to="/dashboard" className="mt-6 inline-block text-primary font-bold hover:underline">
          Return to Dashboard
        </Link>
      </div>
    );
